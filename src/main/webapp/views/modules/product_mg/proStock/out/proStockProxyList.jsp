...
<script type="text/javascript">
	...
	function initProSlt(){
	 ...
	 //初始化机构树
   	var gridTableUrl = $.util.basePath + '/r/proStock/getProxyList';
    function initGridTable(){
    	gridTable = $("#gridTable").bootstrapTable({
            ...
            [
            	...
            	{field: 'proType', title: '所属产品分类'},                {field: 'proName', title: '所属产品'},
    ...
    function openFitDialog(btnEle,id){
    	...
    	var url = "/r/proStock/forwordStockProxyEdit?ids="+ids+"&&proId="+proId ;
    	var width = "780";
		var height = "700";
