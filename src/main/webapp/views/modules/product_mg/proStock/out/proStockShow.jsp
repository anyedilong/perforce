    	...
    	for(var i = 0; i < proDeviceList.length;i++){
        	...
        	if(!$.util.isNull(device)){
            	...
            	for(var j = 0 ; j < count ; j ++){
                	...
                	//附属设备
                	//如果subflg所定义的proDevice.subFlg的值相等选择第一个否则选第二个
                                        ...
                                        <div class="ibox-content">
					                        ...
					                        <div class="row show-row">
					                         ...
					                         <div class="row show-row">
					                            ...
					                            <div class="col-sm-8 show-text">
					                                <lable class="form-control-static show-data" data-name="status"></lable>
					                            </div>
					                        </div>
					                                 <div class="row show-row">
					                            <label class="col-sm-3 control-label font-l">产品装配人：</label>
					                            <div class="col-sm-8 show-text">
					                                <lable class="form-control-static show-data" data-name="fitName"></lable>
					                            </div>
					                        </div>
					                            <div class="row show-row">
