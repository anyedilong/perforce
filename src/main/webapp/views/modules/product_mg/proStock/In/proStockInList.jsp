...
<script type="text/javascript">
	...
	function initProSlt(){
	 ...
	 //初始化机构树
   	var gridTableUrl = $.util.basePath + '/r/proStock/getInList';
    ...
    function openEditRowDialog(id,btnEle){
    	var url = "/r/proStock/forwordStockList?id="+id
    ...
    function openFitDialog(eve){
    	...
    	if(selectionRows.length <= 0){
    		...
    		for(var i = 0 ; i < selectionRows.length ; i++){
    			...
    			var param = {"idList":ids,"proId":proId};
    		}
    	}
    	 //刷新列表
        function refreshTable() {
    		...
    		//发送入库请求
    		var proSltUrl = $.util.basePath + '/r/proStock/InProStock';
    			$.util.ajax({
    				url : proSltUrl,
    				data :{"idList":ids},
    				async : false, // 是否同步
    				success : function(data) {
    					...
    					swal("操作成功","操作成功"+testSuccessCount+"件;"+"操作失败"+testErrorCount+"件<br/>","success");
    					refreshTable()
    				}
    			});
                    ...
                    <div class="ibox-content">
									...
									<!-- 查询条件 -->
									 <td>
	                                   <div class="col-sm search-where-div" >
	                                   		<form class="form-horizontal m-t" id="queryForm" novalidate="novalidate">
						...
						<div class="row-fluid grid-div">
						    ...
						    <div class="columns  handle-button-div" id="handle-div">
						          <button handle-type="inStock" class="btn btn-info button-handle " type="button" onclick="openFitDialog(this)"><i class="fa "></i> </button>
						    </div>
