...
<script type="text/javascript">
    ...
    function openShowDialog(id){
        ...
        var url = "/r/device/forwordShow?id="+id;
        var width = 780;
        var height = 640;
        var title = "用户详情";
  ...
  //打开保存界面
	function openSaveDialog(id,type,eve) {
			var url = "/r/device/forwordEdit?id="+id
			var width = "780";
			var height = "490";
			var title = "编辑设备信息";
			openDialog(null, url, width, height, title);
    ...
    //初始化列表
   	var gridTableUrl = $.util.basePath + '/r/device/getList';
    function initGridTable(){
    	gridTable = $("#gridTable").bootstrapTable({
            ...
            [
                ...
                {field: 'deviceMaker', title: '厂家'},
                {field: 'deviceWarranty', title: '质保期'},
                {field: 'dictDeviceType', title: '设备类型'},
    ...
    function deleteRows(eve){
        var delUrl = $.util.basePath + '/r/device/delete';
...
<!-- 			                                    <div class="form-group">
			                                   	...
			                                   	<div class="form-group">
			                                        ...
			                                        <input type="text" name="deviceMaker"  class="form-control">
			                                    </div>
			                                    <div class="form-group">
