...
public final class SensitiveInfoUtils {  
    ...
    public static String chineseName(String familyName, String givenName) {  
        if (org.apache.commons.lang3.StringUtils.isBlank(familyName) || org.apache.commons.lang3.StringUtils.isBlank(givenName)) {  
            return "";  
        }  
    ...
    public static String idCardNum(String id) {  
        ...
        String num = org.apache.commons.lang3.StringUtils.right(id, 4);  
        return org.apache.commons.lang3.StringUtils.leftPad(num, org.apache.commons.lang3.StringUtils.length(id), "*");  
    }  
    ...
    public static String address(String address, int sensitiveSize) {  
        ...
        int length = org.apache.commons.lang3.StringUtils.length(address);  
        return org.apache.commons.lang3.StringUtils.rightPad(org.apache.commons.lang3.StringUtils.left(address, length - sensitiveSize), length, "*");  
    }  
    ...
    public static String email(String email) {  
        ...
        if (index <= 1)  
            ...
            return org.apache.commons.lang3.StringUtils.rightPad(org.apache.commons.lang3.StringUtils.left(email, 1), index, "*").concat(org.apache.commons.lang3.StringUtils.mid(email, index, org.apache.commons.lang3.StringUtils.length(email)));  
    }  
    ...
    public static String bankCard(String cardNum) {  
        ...
        return org.apache.commons.lang3.StringUtils.left(cardNum, 6).concat(org.apache.commons.lang3.StringUtils.removeStart(org.apache.commons.lang3.StringUtils.leftPad(org.apache.commons.lang3.StringUtils.right(cardNum, 4), org.apache.commons.lang3.StringUtils.length(cardNum), "*"), "******"));  
    }  
    ...
    public static String cnapsCode(String code) {  
        ...
        return org.apache.commons.lang3.StringUtils.rightPad(org.apache.commons.lang3.StringUtils.left(code, 2), org.apache.commons.lang3.StringUtils.length(code), "*");  
    }  
            ...
            for (Field field : fields) {  
                ...
                if (null != field && null != javaBean) {  
                        ...
                        if (type.isArray()) {  
                            ...
                            for (Object o : set) {  
                                ...
                                SensitiveInfoUtils.replace(SensitiveInfoUtils.findAllField(mapVal.getClass()), mapVal, referenceCounter);  
                                   ...
                                   && !org.apache.commons.lang3.StringUtils.startsWith(type.getPackage().getName(), "javax.")  
                                   && !org.apache.commons.lang3.StringUtils.startsWith(type.getPackage().getName(), "java.")  
                                   && !org.apache.commons.lang3.StringUtils.startsWith(field.getType().getName(), "javax.")  
                                   && !org.apache.commons.lang3.StringUtils.startsWith(field.getName(), "java.")  
                    ...
                    if (field.getType().equals(String.class) && null != annotation) {  
                        ...
                        if (org.apache.commons.lang3.StringUtils.isNotBlank(valueStr)) {  
