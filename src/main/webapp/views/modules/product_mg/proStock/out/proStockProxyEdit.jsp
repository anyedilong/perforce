...
<script type="text/javascript">
	...
	var proSltUrl = $.util.basePath + '/r/proStock/outProStock';
	 function saveForm(){ 
		 ...
		 var outProxyUser = $("#proxyIdSel").val();
		 var salesManager = $("#proNum").val();
	    $.util.ajax({
			url : proSltUrl,
			data :{"idList":ids,"outProxyUser":outProxyUser,"salesManager":salesManager},
			async : false, // 是否同步
			success : function(data) {
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="saveForm" novalidate="novalidate">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="proxyIdSel" name="outProxyUser"  data-placeholder="选择代理商..."  style="width:350px;" class="chosen-select-deselect" tabindex="12">
                                    </select>
                                </div>
                            </div>  
